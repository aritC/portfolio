...
export default function Contact() {
  ...
  return (
    <div className="w-screen mb-20">
      <div className="text-white grid items-center lg:grid-cols-2 ml-auto mr-auto min-content lg:w-9/12 ">
        <div className="p-10">
          ...
          <div>
            <div className="flex justify-center pt-10 h-24">
              <a
                href="https://www.linkedin.com/in/aritc/"
                rel="noreferrer"
                target="_blank"
              >
                <LINKEDIN className="fill-white h-20 transition-all hover:h-24 hover:-translate-y-2" />
              </a>{" "}
              <a
                ...
                target="_blank"
              >
                <GITHUB className="fill-white h-[5.5rem] -translate-y-1 transition-all hover:h-24 hover:-translate-y-2" />
              </a>
            </div>
            <div></div>
          </div>
