...
const Hero = () => {
  ...
  return (
    <div className="h-screen w-screen ">
      <div
        className="text-white text-center place-items-center justify-center grid grid-rows-auto grid-cols-1 md:grid-rows-1 md:grid-cols-2 ml-auto mr-auto min-content md:w-9/12"
        id="hero"
      >
        <Image
          priority
          src={me}
          className="rounded-3xl md:w-[30rem] w-2/5 aspect"
          alt="Arit Chanda"
        />
